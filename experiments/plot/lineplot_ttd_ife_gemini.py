...
C_TTD = "#1f77b4"   # blue  — TTD bars  (left axis)
C_IFE = "#de2d26"   # red   — IFE line  (right axis)
...
# ── TTD bars — left, green ────────────────────────────────────────────────────
ax1.bar(x, ttd_means, width=BAR_W, color=C_TTD,
        edgecolor=_darken(C_TTD), linewidth=0.8, zorder=3)
...
# ── Axis colouring ─────────────────────────────────────────────────────────────
dark_green = _darken(C_TTD)
dark_red = _darken(C_IFE)

# Main axis (ax1) - Handles Left (Green), Top (Black), Bottom (Black)
ax1.set_ylabel("Time to Detection (s)", color=dark_green)
