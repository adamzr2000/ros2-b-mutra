...
def export_attestation_times_json(participant_name: str,
    ...
    ROLE_FIELDS = {
        ...
        "oracle": {
            ...
            "t_get_prover_ref_signature_db_start": ["get_prover_ref_signature_db_start"],
            "t_get_prover_ref_signature_db_finished": ["get_prover_ref_signature_db_finished"],
            "t_prover_ref_signature_sent": ["prover_ref_signature_sent"],
            "t_prover_ref_signature_sent_tx_confirmed": ["prover_ref_signature_sent_tx_confirmed"],
