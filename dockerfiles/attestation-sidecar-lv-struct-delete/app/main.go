...
func main() {
	...
	// 5. Register agent and optionally auto-start
	...
	// POST /config  {"results_dir": "...", "one_shot": true|false, "export_enabled": true|false, "attestation_interval_ms": N}
	...
	r.POST("/config", func(c *gin.Context) {
		...
		if body.ResultsDir == nil && body.ResultsFile == nil && body.OneShot == nil && body.ExportEnabled == nil && body.AttestationIntervalMs == nil {
			c.JSON(400, gin.H{"error": "no recognized fields: use results_dir, results_file, one_shot, export_enabled, attestation_interval_ms"})
			return
		}
